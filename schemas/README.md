...
bytes and reject duplicate object keys before Foundation decoding. Project profile schema version 1
allows at most 256 explicit source paths, and validation output is capped at 256 issues.
