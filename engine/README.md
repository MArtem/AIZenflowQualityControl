...
package-internal static coordinator both fail closed; neither is a public execution-boundary or
workflow evidence producer, and no cryptographic attestation exists yet. Future execution surfaces
