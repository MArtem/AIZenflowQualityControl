...
7.1 verifier acceptance run passed 172 tests in 16 suites with warnings treated as errors. The 6.2
baseline immediately before the verifier additions passed 164 tests in 16 suites. The earlier
Stage 9D3 corrective full run passed 118 tests in ten suites, and the Stage 7/9A corrective contained run
passed 58 tests in four suites. The combined matrix includes
